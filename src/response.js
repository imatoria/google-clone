const response = {
  ...
  items: [
    ...
    },
    {
      ...
      displayLink: "www.tesla.com",
      snippet:
        "Solar Roof replaces your existing roof and brings it to life with beautiful solar tiles \nthat can power your home for decades with the energy you produce.",
      htmlSnippet:
        "Solar Roof replaces your existing roof and brings it to life with beautiful solar tiles \u003cbr\u003e\nthat can power your home for decades with the energy you produce.",
      ...
      pagemap: {
        cse_thumbnail: [
          {
            src:
              "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR_lB8IjjMdqFojG8fpJSSsRAR0wAVy3BCmntVfAN-ZFtbiu3QoX2jd7wo",
            width: "284",
            height: "177",
          },
        ],
